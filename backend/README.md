...
## Project Structure
    ...
    ├── test_app_data_viz_38100  # Django project configurations
...
1. Clone this repo and `cd test_app_data_viz_38100`
...
2. Clone this repo and `cd test_app_data_viz_38100`
